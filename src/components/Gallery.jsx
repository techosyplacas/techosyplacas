        ...
        <section className="gallery" id="galleryHome">
            <div className="content__gallery">
                <div className="text__gallery grilla">
                    ...
                    <span>Mira nuestra galería de trabajos</span>
                ...
                <div className="images__gallery">
                    ...
                    <div
                        onMouseEnter={() => setShowImgInfo2(true)}
                        onMouseLeave={() => setShowImgInfo2(false)}
                        className="img_contain"
                    >
                    ...
                    <div
                        onMouseEnter={() => setShowImgInfo3(true)}
                        onMouseLeave={() => setShowImgInfo3(false)}
                        className="img_contain"
                    >
                    ...
                    <div
                        onMouseEnter={() => setShowImgInfo4(true)}
                        onMouseLeave={() => setShowImgInfo4(false)}
                        className="img_contain"
                    >
                    ...
                    <div
                        onMouseEnter={() => setShowImgInfo5(true)}
                        onMouseLeave={() => setShowImgInfo5(false)}
                        className="img_contain"
                    >
                        <img src={techo5} alt="techo en shingle" />
                        <div className={`img__info ${showImgInfo5 && "show__img__info"}`}>
                            <span>Impermeabilización de placas</span>
                            <button onClick={() => setShowFloatForm(true)}>Más info</button>
                        </div>
                    </div>

                    <div
                        onMouseEnter={() => setShowImgInfo6(true)}
                        onMouseLeave={() => setShowImgInfo6(false)}
                        className="img_contain"
                    >
                        <img src={techo6} alt="techo en shingle" />
                        <div className={`img__info ${showImgInfo6 && "show__img__info"}`}>
                            <span>Impermeabilización de canales</span>
                            <button onClick={() => setShowFloatForm(true)}>Más info</button>
                        </div>
                    </div>

                    <div
                        onMouseEnter={() => setShowImgInfo7(true)}
                        onMouseLeave={() => setShowImgInfo7(false)}
                        className="img_contain"
                    >
                        <img src={techo7} alt="teja termoacustica" />
                        <div className={`img__info ${showImgInfo7 && "show__img__info"}`}>
                            <span>Instalación de techos</span>
                            <button onClick={() => setShowFloatForm(true)}>Más info</button>
                        </div>
                    </div>

                    <div
                        onMouseEnter={() => setShowImgInfo8(true)}
                        onMouseLeave={() => setShowImgInfo8(false)}
                        className="img_contain"
                    >
